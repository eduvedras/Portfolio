...
export default function Pokemon() {
    return (
        <main className='px-10 md:px-20 lg:px-40 bg-slate-900'>
            ...
            <div className='pt-5 pb-5'>
                ...
                <p className='text-md leading-7 pt-2 pb-5 text-gray-200'>
                    If you want to learn more about the project, click <span className='font-extrabold text-gray-200 hover:text-teal-500'>here</span> to download the report
